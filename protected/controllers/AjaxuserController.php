...
class AjaxuserController extends CController {
    ...
    public function actionAddOrden() {
        ...
        $req = array(
            ...
            'ciudad_origen_id_n' => Driver::t("Por favor ingrese ciudad origen"),
            'ciudad_destino_id_n' => Driver::t("Por favor ingrese ciudad destino")
        );
        $Validator = new Validator;
        $Validator->required($req, $this->data);
        if ($Validator->validate()) {
    ...
    public function actionAddContacto() {
        ...
        if ($Validator->validate() && $this->data['zona'] != '0') {
            ...
            $params = array(
                ...
                'zona' => $this->data['ciudad_id_n'] == 2 ? 184 : 185,
